  ...
  return (
    <Main>
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-base leading-7 text-gray-600 dark:text-white">Hi {user != null ? user.firstName: 'there'}, It seems you miss your way. Sorry, we couldn’t find the page you’re looking for.</p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="mailto:support@atendiconsulting.com" className="text-sm font-semibold text-gray-900 dark:text-white">
