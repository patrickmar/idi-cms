        ...
        <div className="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
          ...
          <form className="mt-8 space-y-6" action="/">
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  name="remember"
                  type="checkbox"
                  className="w-4 h-4 text-orange-600 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-orange-300 dark:focus:ring-orange-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
                  required
                />
              </div>
            ...
            <button
              ...
              onClick={onSubmit}
              className={`${
                isLoading ? "cursor-not-allowed bg-orange-400 opacity-25" : ""
              } w-full px-5 py-3 text-base font-medium text-center text-white bg-orange-700 rounded-lg hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 sm:w-auto dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800`}
            >
              <ButtonLoader
                isLoading={isLoading}
                text="Create account"
